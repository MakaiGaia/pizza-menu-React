...
export default function Menu(){
    ...
    //Funcion para borrar pizzas y actualizar estado
    ...
    return(
        <main className="menu">
            <h2>Our menu</h2>
            {pizzas.length > 0 ? 
            //Esta etiqueta <> </> se conoce como fragment, y no se rendieriza en la aplicación, nos sirve como contenedor padre pero sin ser renderizada en HTML
            (<> 
                <p>
